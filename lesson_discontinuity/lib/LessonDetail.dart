...
class _lessonDetailState extends State<LessonDetail> {
  ...
  Future<void> lessonUpdate(int lessonId,String lessonCode,int lessonDiscontinuity ) async{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Lesson Update"),),
          ...
          child: Column(
            ...
            children: [
              TextField(
                ...
                decoration: const InputDecoration(labelText: "Enter Lesson Code",),
              ),
              TextField(
                controller: tfDetailDiscontinuity,
                decoration: const InputDecoration(labelText: "Enter Discontinuity",),
              ),
            ],
          ),
        ),
